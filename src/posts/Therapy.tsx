  ...
  <div>
    ...
    <p>
      ...
      <a
        ...
        target="_blank"
      >
        Art vs AI rant on Instagram the other day
      </a>{' '}
      a few people were concerned about my wellbeing, and rightfully so - a
      little out of character for me to go on rants. I generally don't think
      people will listen to what I have to say. But, after some really nice and
      heartfelt comments, I felt empowered to write about something else that
      has been on my mind lately: the stigma of going to therapy.
    </p>
    <p>
      Therapy is an interesting topic. I think my parents' generation believe
      that only the "mentally ill" people go to see a psychologist, but I want
      to express that I truly think everyone could benefit from it and should be
      treating it the same as going to see their doctor (GP), dentist or car
      mechanic.
    </p>
    <p>
      ...
      face them - head on. "But, how? How do I face the insurmountable
      challenges before me?" you say.
    </p>
    <p>
      Well, what are the opposites to what I mentioned above, the antitheses of
      pain, suffering and fear. It's love, happiness and courage. You will need
      to feel and practice these daily, to be free. Your friends, family and
      support network will help you get there but ultimately it is you and you
      alone who will have to come to realisations about yourself to get through.
    </p>
    <p>
      I believe some of the actions you can take is to ask yourself the right
    ...
    <div class="image-with-caption-wrapper">
      <img
        ...
        alt="Gom Jabbar and Paul Atreides - Test of fear - Dune  (2021)"
      />
      <p class="caption">
    ...
    <blockquote>
      ...
      my fear. <strong>I</strong> will permit it to pass over{' '}
      <strong>me</strong> and through <strong>me</strong>. And when it has gone
      past <strong>I</strong> will turn the inner eye to see its path. Where the
      fear has gone there will be nothing. Only <strong>I</strong> will remain."
      - Frank Herbert, Dune 1965
    </blockquote>
    <p>
      We all have some level of fear and suffering, and that's okay - we won't
      ever be able to fully be free of it. But therapy helps us cope and equips
      us with the ability to move forward rather than to have events or thought
    ...
    <p>
      ...
      will only take an hour out of your day - and, who knows, you might just
